...
- **theceoagent.ai divergence**: the `doralevich/theceoagent-site` repo contains a static
  `index.html`, but the live site is a Next.js app. They are not the same site. Resolve
  which is authoritative before migrating the CEO site.
