...
// puppeteer is required lazily below to avoid Vercel bundle issues
...
<body>
  ...
  // Detect Vercel/Lambda environment — use @sparticuz/chromium if available, puppeteer locally
  let browser;
