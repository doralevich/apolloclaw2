...
// (large) zone, so we count enters minus leaves rather than inspecting relatedTarget — the
// latter is null on Safari/Firefox, which would strobe the overlay on each child boundary
// crossing.
