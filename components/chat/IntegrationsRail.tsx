...
export function IntegrationsRail({
   ...
   *
   * Owned by ChatView rather than here, because hiding it has to give the space back — a panel
   * that slides out and leaves its gap behind has moved, not closed. The parent animates its own
   * width; this component only asks.
   */
  onHide: () => void;
}) {
