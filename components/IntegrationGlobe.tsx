...
// ---- Palette (edit to match Apollo Claw) ---------------------------------------------------------
const BRAND = "#3d8b3d"; // accent (kicker + CTA)
const CREAM = "#f6f5f2"; // section background
const INK = "#0b1729"; // headings / body
...
// The scrolling marquee below the globe.
const MARQUEE_LOGOS = [
