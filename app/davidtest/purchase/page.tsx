...
// Step one of the purchase walkthrough: pick an agent.
//
// THIS USED TO BE /demo. It moved here when /demo became Donna's chat for clients: the walkthrough
// is admin-only and always was, so the only thing it loses by sitting under /davidtest is a
// shorter URL, and /demo was the obvious address for the one page clients are sent to.
//
...
export const metadata = { title: "Purchase walkthrough" };
