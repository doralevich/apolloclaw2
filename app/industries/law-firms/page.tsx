  ...
  return (
    <>
      ...
      <AgentHero
        ...
        title={<>Bill More Hours.<br />Miss Zero Deadlines.</>}
        punch="The Law Agent. More Than AI. Your Firm's Operating System."
        sub="The Law Agent handles client intake, deadline tracking, document summaries, and client communication so your attorneys stay focused on billable work."
      />
      ...
      <CaseStudiesSection industryPath="/industries/law-firms" />
    </>
  );
}
