...
export default function InsurancePage() {
  return (
    <>
      ...
      <AgentHero
        agentTypeId="insurance"
        buildSlug="insurance"
        badge="Apollo[Claw] Insurance Edition"
        title={<>Write More Business.<br />Lose Fewer Renewals.</>}
        punch="The Insurance Agent. More Than AI. Your Agency's Operating System."
        sub="The Insurance Agent handles quote follow-up, renewal outreach, claims communication, and client management so your producers stay focused on selling."
      />
      {/* Value Prop */}
      ...
      <CaseStudiesSection industryPath="/industries/insurance" />
    </>
  );
}
