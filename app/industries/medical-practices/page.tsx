  ...
  return (
    <>
      ...
      <AgentHero
        ...
        title={<>See More Patients.<br />Lose Fewer to No-Shows.</>}
        punch="The Medical Agent. More Than AI. Your Practice's Operating System."
        sub="The Medical Agent handles scheduling, patient follow-up, documentation prep, and intake so your providers stay focused on care."
      />
      {/* Value Prop */}
      ...
      <CaseStudiesSection industryPath="/industries/medical-practices" />
    </>
  );
}
