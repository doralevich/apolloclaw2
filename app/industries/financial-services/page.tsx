...
const uc = {
  ...
  solutions: [
    ...
    { title: "Onboarding Automation", desc: "AI guides incoming clients through document collection, compliance forms, and account setup so advisors spend time advising, not processing." },
