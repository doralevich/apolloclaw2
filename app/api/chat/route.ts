...
- Guide visitors to schedule a consultation at https://cal.com/therealdaveo/dbdo-consultation
...
- Once you see [LEAD: name, email] in the conversation:
  ...
  3. After 2 exchanges post-lead, naturally offer to book a call: "I think a quick 45-minute strategy call with David would be perfect for your situation. You can grab a time here: https://cal.com/therealdaveo/dbdo-consultation"
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (blockedTerms.some(term => lastUserMsg.includes(term))) {
      return NextResponse.json({ message: "I'm here to help you explore AI for your business. Want to book a free 45-minute strategy call with our team? https://cal.com/therealdaveo/dbdo-consultation" });
    }
