...
export const metadata: Metadata = {
  ...
  description:
    "Apollo Claw's enterprise AI solutions help leadership teams design and deploy AI across the entire organization, department by department, from strategy to execution.",
