...
export default function GetStartedPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-5 py-10 pt-8">
      <div className="w-full max-w-2xl animate-fade-up">
        <div className="text-center">
          <div className="w-10 h-[3px] bg-primary mb-5 mx-auto" />
          <h1 className="font-mono text-[28px] font-bold tracking-tight leading-[1.1] mb-2.5 text-foreground">
            Schedule <span className="text-primary">Today.</span>
          </h1>
          <p className="text-sm text-muted-foreground leading-relaxed font-light max-w-md mx-auto mb-8">
            Pick a time that works for you and we&apos;ll connect live.
          </p>
          <div
        ...
        <div className="mt-10 text-center">
          <div className="w-10 h-[3px] bg-primary mb-5 mx-auto" />
          <h2 className="font-mono text-[28px] font-bold tracking-tight leading-[1.1] mb-2.5 text-foreground">
