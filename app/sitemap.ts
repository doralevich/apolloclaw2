...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = [
    ...
    { path: "/ai-101",                   priority: 0.6 },
    { path: "/use-cases/health",         priority: 0.7 },
    { path: "/use-cases/legal",          priority: 0.7 },
    { path: "/use-cases/accounting",     priority: 0.7 },
    { path: "/use-cases/real-estate",    priority: 0.7 },
    { path: "/use-cases/construction",   priority: 0.7 },
    { path: "/use-cases/ecommerce",      priority: 0.7 },
    { path: "/use-cases/finance",        priority: 0.7 },
    { path: "/use-cases/insurance",      priority: 0.7 },
    { path: "/use-cases/restaurants",    priority: 0.7 },
    { path: "/use-cases/nonprofit",      priority: 0.7 },
  ].map(({ path, priority }) => ({
